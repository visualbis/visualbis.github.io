...
.. figure:: _static/simu1.png   
    :align: center
    :alt: alternate text

    Simulate Tab option 

The common functionalities of the Simulate Tab has been already explained in
:ref:`Section: General Features of valQ Custom Visual <GFV>` 